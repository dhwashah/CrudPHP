...
?>
  ...
  <div class="text-center">
    <div id='tabla' class="h1">Departamentos</div>
  </div>
...
echo "<td><h4><strong>Codigo Departamento</h4></strong></td>";
...
echo "</tr>";
	...
	while ($registro = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) {
		echo "<tr class='text-center'>";
			echo "<td style='vertical-align:middle'>".$registro['codDepartamento']."</td>";
			echo "<td style='vertical-align:middle'>".$registro['nomDepartamento']."</td>";

			echo "<td><button class='btn btn-primary' type='submit' name='modificarDepartamento' value='".$registro['codDepartamento']."'>modificar</button></td>";			
			echo "<td><a name='eliminar' class='btn btn-danger' data-toggle='modal' data-target='#eliminarModal' value=".$registro['codDepartamento'].">eliminar</a></td>";
			
		echo "</tr>";
	}
echo "<tr><td colspan='6' class='text-right'><button class='btn btn-success' type='submit' name='insertarDepartamento' value='insertar'>insertar</button></td></tr>";
echo "</table>";
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
              	<form action="php/eliminar.php" method="post">
                	...
                	<button id='btnEliminar' type="submit" name="eliminarDepartamento" value=-1 class="btn btn-default"> Si </button>
                </form>
              </div>
            </div>
          </div>
