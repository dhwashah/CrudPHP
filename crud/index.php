...
?>
  ...
  <div class="text-center">
    <div id='tabla' class="h1">Proyectos</div>
  </div>
...
$query = 'SELECT pro.codProyecto, pro.nomProyecto, dep.nomDepartamento, pro.fechaInicioProyecto
...
echo "<td><h4><strong>Fecha</h4></strong></td>";
echo "<td></td>";
echo "<td></td>";
echo "<td></td>";
echo "</tr>";
	...
	while ($registro = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) {
		echo "<tr class='text-center'>";
			...
			echo "<td><button class='btn btn-primary' type='submit' name='detalleProyecto' value='".$registro['codProyecto']."'>detalle</button></td>";
			echo "<td><button class='btn btn-primary' type='submit' name='modificarProyecto' value='".$registro['codProyecto']."'>modificar</button></td>";			
			echo "<td><a name='eliminar' class='btn btn-danger' data-toggle='modal' data-target='#eliminarModal' value=".$registro['codProyecto'].">eliminar</a></td>";
			
		echo "</tr>";
	}
echo "<tr><td colspan='7' class='text-right'><button class='btn btn-success' type='submit' name='insertarProyecto' value='insertarProyecto'>insertar</button></td></tr>";
echo "</table>";
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
              	<form action="proceso.php" method="post">
                	...
                	<button id='btnEliminar' type="submit" name="eliminarProyecto" value=-1 class="btn btn-default"> Si </button>
                </form>
              </div>
            </div>
          </div>
